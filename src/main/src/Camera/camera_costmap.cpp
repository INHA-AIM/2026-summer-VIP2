...
private:
    ...
    const int IMG_W = 300;
    const int IMG_H = 237; // 237

    // Costmap 설정
    const float GRID_RES = 0.05f;    // 1칸당 5cm
    // const int GRID_W = 550;         // 30m 커버 (가로)
    // const int GRID_H = 540;         // 30m 커버 (세로)
    const int GRID_W = 700;         // 30m 커버 (가로)
    const int GRID_H = 1000;         // 30m 커버 (세로)
