...
//         cube_marker.header.stamp = ros::Time(0);
...
//         text_marker.header.stamp = ros::Time(0);
...
//         // 표시할 텍스트 설정
//         double velocity_kmh = det.v * 3.6;
//         std::ostringstream oss;
//         oss << "ID: " << det.id << " | V: " << std::fixed << std::setprecision(1) << velocity_kmh << " km/h";
//         text_marker.text = oss.str();
        
//         text_marker.lifetime = ros::Duration(0.12);
...
//         // Yaw 각도를 Quaternion으로 변환 (나누지 않은 yaw 사용)
//         double half_yaw = det.yaw * 0.5;
...
//         arrow_marker.scale.x = 1.0 + (det.v * 0.5); // 속도에 따라 화살표가 길어짐
//         arrow_marker.scale.y = 0.15; 
//         arrow_marker.scale.z = 0.15; 
        
//         arrow_marker.color.r = 1.0f; arrow_marker.color.g = 1.0f; arrow_marker.color.b = 0.0f;
//         arrow_marker.color.a = 1.0f;
        
//         arrow_marker.lifetime = ros::Duration(0.12);
